...
> 💡 **نکته:** پست‌هایی که ویدیو، صدا یا فایل دارند، یه باکس مخصوص دانلود دارند. لینک پست رو با یه کلیک روی آیکون کپی کنید، بعد برید **Actions ← ⬇️ Download Telegram Post** و paste کنید.
